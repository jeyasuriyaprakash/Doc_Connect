        ...
        <View>
          ...
          >
            ...
            >
              ...
              />
              <View style={{ marginRight: 30, justifyContent: "space-evenly" }}>
                <Text
            ...
            >
              ...
              >
                Token no : Abc1{" "}
                <Text
                  style={{ color: "#0FB800", fontSize: 15, fontWeight: "500" }}
                >
                  {" "}
                  (Completed)
                </Text>{" "}
            ...
            >
              <TouchableOpacity
                ...
                }}  onPress={() => {setSelectedTab(0);}} onPressIn={()=>alert('you want to cancel')}
              >
                <Text
                  style={{ color:  selectedTab == 0 ?  "#ffffff" : "#0856ff", fontSize: 10, fontWeight: "600" }}
                >
                  Book Again
                </Text>
              </TouchableOpacity>
              ...
              >
                <Text
                  style={{ color: selectedTab == 1 ?  "#ffffff" : "#0856ff", fontSize: 10, fontWeight: "600" }}
                >
                  Leave a Review
                </Text>
              </TouchableOpacity>
            ...
            >
              <TouchableOpacity
                style={{
                  ...
                  alignItems: "center",
                  justifyContent: "center",
                }}  onPress={() => {setSelectedTab1(0);}} onPressIn={()=>alert('you want to cancel')}
              >
                <Text
                  style={{ color:  selectedTab1 == 0 ?  "#ffffff" : "#0856ff", fontSize: 10, fontWeight: "600" }}
                >
                  Book Again
                </Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity
                style={{
                  ...
                  alignItems: "center",
                  justifyContent: "center",
                }}  onPress={() => {setSelectedTab1(1);}}
              >
                <Text
                  style={{ color: selectedTab1 == 1 ?  "#ffffff" : "#0856ff", fontSize: 10, fontWeight: "600" }}
                >
                  Leave a Review
                </Text>
              </TouchableOpacity>
            ...
            >
              <TouchableOpacity
                style={{
                  ...
                  alignItems: "center",
                  justifyContent: "center",
                }}  onPress={() => {setSelectedTab2(0);}} onPressIn={()=>alert('you want to cancel')}
              >
                <Text
                  style={{ color:  selectedTab2 == 0 ?  "#ffffff" : "#0856ff", fontSize: 10, fontWeight: "600" }}
                >
                  Book Again
                </Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity
                style={{
                  ...
                  alignItems: "center",
                  justifyContent: "center",
                }}  onPress={() => {setSelectedTab2(1);}}
              >
                <Text
                  style={{ color: selectedTab2 == 1 ?  "#ffffff" : "#0856ff", fontSize: 10, fontWeight: "600" }}
                >
                  Leave a Review
                </Text>
              </TouchableOpacity>
